...
class GlobalSettings(BaseSettings):
    ...
    # 应用信息
    app_name: str = Field(default="{{ cookiecutter.project_slug }}", description="应用名称")
    app_version: str = Field(default="1.0.0", description="应用版本")
    app_description: str = Field(default="{{ cookiecutter.project_description }}", description="应用描述")
